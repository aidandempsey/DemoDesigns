...
HD_PWD='C:/videodemo/Sequential/Sequential/Counters/CB4CLED/Verilog/AMDprj/CB4CLED.runs/CB4CLED_bd_TC_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CB4CLED_bd_TC_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CB4CLED_bd_TC_0.tcl
