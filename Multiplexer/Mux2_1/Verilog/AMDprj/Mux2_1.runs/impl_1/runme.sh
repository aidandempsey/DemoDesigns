...
HD_PWD='C:/videodemo/HDLGen-ChatGPT/User_Projects/Mux2_1/Verilog/AMDprj/Mux2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux2_1_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mux2_1_bd_wrapper.tcl -notrace
