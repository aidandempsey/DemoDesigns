...
HD_PWD='C:/demo/RISCV/RISCV_ALU/VHDL/AMDprj/RISCV_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_ALU_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_ALU_bd_wrapper.tcl -notrace
