-- Title Section Start
-- Generated by HDLGen, Github https://github.com/HDLGen-ChatGPT/HDLGen-ChatGPT, on 11-March-2024 at 23:17
...
begin
    ...
    case selALUOp is 
        when "0000" =>
            ALUOut <= std_logic_vector(resize(signed(A) + signed(B), ALUOut'length));
        when "0001" =>
            ALUOut <= std_logic_vector(resize(signed(A) - signed(B), ALUOut'length));
        when "0010" =>
            ALUOut <= A and B;
