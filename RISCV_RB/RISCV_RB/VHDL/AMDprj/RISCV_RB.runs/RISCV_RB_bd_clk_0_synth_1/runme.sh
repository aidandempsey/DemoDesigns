...
HD_PWD='C:/videodemo/HDLGen-ChatGPT/User_Projects/RISCV_RB/RISCV_RB/VHDL/AMDprj/RISCV_RB.runs/RISCV_RB_bd_clk_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_RB_bd_clk_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_RB_bd_clk_0.tcl
