...
HD_PWD='C:/videodemo/HDLGen-ChatGPT/User_Projects/RISCV_RB/RISCV_RB/VHDL/AMDprj/RISCV_RB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_RB_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_RB_bd_wrapper.tcl -notrace
