...
HD_PWD='C:/videodemo/FiniteStateMachines_FSMs/singleShot/VHDL/AMDprj/singleShot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log singleShot_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source singleShot_bd_wrapper.tcl -notrace
