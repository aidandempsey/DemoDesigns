...
HD_PWD='C:/videodemo/FiniteStateMachines_FSMs/singleShot/VHDL/AMDprj/singleShot.runs/singleShot_bd_aShot_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singleShot_bd_aShot_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleShot_bd_aShot_0.tcl
